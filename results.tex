...
\vspace{1mm}
\centering
\resizebox{350pt}{!}{\input{tables/stab_th}}
\end{table}
...
\vspace{1mm}
\centering
\resizebox{350pt}{!}{\input{tables/runtime_th}}
\end{table}
...
\begin{table}[h!]
\caption{The \textbf{speedup} provided by Hybrid over Annealing and AIMD modes, ranging from 1.04x to 1.32x.  }\label{tab:speed}
\vspace{1mm}
\centering
\resizebox{350pt}{!}{\input{tables/speed}}
\end{table}

%Speed-up thermal table

\begin{table}[h!]
\caption{The \textbf{speedup} provided by Hybrid modes in 3 thermal scenarios. Averagely, Hybrid accelerates the execution 1.16x and 1.14x over Annealing and AIMD across 3 thermal environments.}\label{tab:speed_th}
\vspace{1mm}
\centering
\resizebox{350pt}{!}{\input{tables/speed_th}}
\end{table}
...
\begin{table}[h!]
\caption{The mean and stdev of \textbf{RSME} of all temperature samples for 6 benchmarks in 3 modes of Sparta. Compared to Annealing and AIMD, Hybrid mode has less RSME to threshold temperature across all benchmarks.}\label{tab:rsme}
\vspace{1mm}
\centering
...
\begin{table}[h!]
\caption{The mean \textbf{RSME} of all temperature samples in 3 thermal scenarios. Compared to Annealing and AIMD, Hybrid mode has less RSME to threshold temperature across 3 thermal environments.  }\label{tab:rsme_th}
\vspace{1mm}
\centering
\resizebox{350pt}{!}{\input{tables/rsme_th}}
\end{table}
